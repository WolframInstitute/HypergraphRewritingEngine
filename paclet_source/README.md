...
A high-performance Wolfram Language paclet for hypergraph rewriting and Wolfram Physics model simulation.
...
- Wolfram Language 13.0 or later
...
In the Wolfram Language, evaluate:
...
3. **Manual override**: Set `WOLFRAM_LANGUAGE_INSTALL_DIR` if CMake can't find the Wolfram Language
...
3. **Wolfram Language headers**: CMake must find the Wolfram Language installation (set `WOLFRAM_LANGUAGE_INSTALL_DIR` if needed)
