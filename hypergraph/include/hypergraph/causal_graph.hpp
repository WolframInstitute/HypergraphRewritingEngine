...
class CausalGraph {
    ...
    WorkerFilteredSet<ShardedKeySet<uint64_t>> seen_causal_triples_;
    ...
    WorkerFilteredSet<ShardedKeySet<uint64_t>> seen_causal_event_pairs_;
    ...
    WorkerFilteredSet<ShardedKeySet<uint64_t>> seen_branchial_pairs_;
