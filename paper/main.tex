...
multiway hypergraph rewriting engine for CPU and GPU. Every state is identified exactly by a
McKay-style individualization--refinement canonical hash, computed by one implementation shared
...
acquire load issues an acquire fence before reading the edge set. So a reader of a published state
